...
class DashboardController extends Controller
{
    ...
    {
        // Totales generales (solo lectura)
        ...
        // Ventas recientes (solo las del empleado actual)
        ...
        // Completar días faltantes con valores en 0
        $last7Days = collect();
        for ($i = 6; $i >= 0; $i--) {
        ...
        // Alertas de productos - Solo informativas
